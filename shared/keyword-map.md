...
| `/mcs-150-biennial-update/` | NEW | mcs-150 update (6,600/7) | biennial update fmcsa (2,400/35) | Informational / BOFU | Recurring-compliance money page; low competition. |
...
| `/ifta-registration/` | NEW | ifta registration (480/28) | ifta sticker, ifta filing | Navigational / BOFU | Fuel-tax filing. Cross-links tightly with `/irp-registration/` (operationally paired) but distinct entity + worked example. |
| `/fmcsa-clearinghouse-registration/` | NEW | fmcsa clearinghouse registration (480/25) | clearinghouse registration | Navigational / BOFU | |
...
| `/eld-services/` | NEW | eld for owner operators (210) | eld compliance (320/35), best eld for owner operators | Commercial / BOFU (CPC $23) | ELD setup; Motive ELD partner (do not call exclusive). "eld compliance" is the higher-KD informational head, kept secondary. |
| `/trucking-insurance-filing/` | NEW (low-priority) | bmc-91 filing (70/1) | trucking insurance filing, fmcsa insurance filing | Navigational / BOFU (CPC $33) | Thin but covers the insurance-filing packet item (near-zero generic volume; KD1, high CPC). Also surfaced as a section on `/mc-registration/` + the hub. Build last. |
