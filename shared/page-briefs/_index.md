...
**Four bundles (DERIVED, never hardcoded):** Compliance Continuation Non-CDL **$400** (val $476, save $76, 16.0%) · Compliance Continuation CDL/Heavy **$1,100** (val $1,351, save $251, 18.6%) · Authority Launch Non-CDL **$1,000** (val $1,126, save $126, 11.2%) · Authority Launch CDL/Heavy **$1,700** (val $2,001, save $301, 15.0%). BOC-3 included in every card; +$4 rounding each; picked by authority status × vehicle type. Replaces the single $1,700 package. See `/compliance-packages/`.
