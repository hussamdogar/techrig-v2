...
Need driver compliance and interstate filings too (DQ files, Clearinghouse, consortium, IRP, IFTA)? Our [compliance packages](/compliance-packages/) bundle it: Authority Launch — Non-CDL ($996) or Authority Launch — CDL/Heavy ($1,696).
...
- Getting it all as one lower-priced bundle: the [Authority Launch packages](/compliance-packages/) ($996 non-CDL / $1,696 CDL/heavy), which use the discounted in-bundle prices and include the MC and UCR (0-2 bracket) government fees.
